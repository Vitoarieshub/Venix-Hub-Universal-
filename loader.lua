local Configs_HUB = {
    Cor_Hub = Color3.fromRGB(24, 24, 27),
    Cor_Options = Color3.fromRGB(32, 34, 37),
    Cor_Stroke = Color3.fromRGB(17, 197, 217),
    Cor_Text = Color3.fromRGB(255, 255, 255),
    Cor_DarkText = Color3.fromRGB(220, 220, 220),
...
function MakeNotifi(Configs)
  local Title = Configs.Title or "Venix Hub"
...
function MakeWindow(Configs)
  local title = Configs.Hub.Title or "Venix"
  local Anim_Title = Configs.Hub.Animation or "by : Venix"
  ...
  local function CreateClose()
    ...
    local Mensage = Create("TextLabel", CloseMenu, {
      ...
      Text = "Do you want to close this script??",
